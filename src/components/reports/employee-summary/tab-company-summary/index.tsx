...
const TabCompanySummary = (props: ITabEmployeeSummaryProps) => {
    ...
    const sections = [
        ...
        },
        {
            ...
            component: <GraduatedSummary tab={tab} currentTab={currentTab} hiddenTabs={['GraduatedByBU']} moduleName={moduleName} />
        },
        {
...
export default TabCompanySummary;
