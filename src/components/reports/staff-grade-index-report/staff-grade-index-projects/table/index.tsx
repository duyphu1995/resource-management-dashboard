...
const StaffGradeIndexReportProjectTable = ({ data, loading }: Props) => {
    ...
    const columns: TableColumnsType<IStaffGradeIndexReport> = [
        {
            ...
            width: 237,
            fixed: 'left',
            render: (record: IStaffGradeIndexReport) => renderWithFallback(record?.projectName),
    ...
    return (
        <div className="staff-grade-index-report-projects-table">
            <BaseTable
                dataSource={data}
                style={{ marginTop: 12 }}
                columns={columns}
...
export default StaffGradeIndexReportProjectTable;
