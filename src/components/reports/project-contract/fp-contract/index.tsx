...
const FPContract = ({ filterData }: { filterData?: IFilterDataChildren }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setIsLoading(true);
            try {
                const response = await projectContractReportServices.getProjectContractByType('Fixed', filterData);
    ...
    return (
        <BaseTable
            ...
            className="fp-contract"
        />
    );
};

export default FPContract;
