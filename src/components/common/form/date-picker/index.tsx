...
const DatePicker = (props: IDatePicker) => {
    const { suffixIcon, format, value, placeholder } = props;
    const dateFormat = format || TIME_FORMAT.US_DATE;
    const valueFormat = value ? dayjs(formatTimeMonthDayYear(value)) : undefined;
    const placeholderDefault = placeholder || 'MMM DD, YYYY';
