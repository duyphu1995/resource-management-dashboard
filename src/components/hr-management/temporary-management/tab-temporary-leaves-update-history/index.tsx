...
const TabTemporaryLeaveUpdateHistory = (props: ITableHaveActionAddProps<any>) => {
    ...
    // Get data history updated
    useEffect(() => {
        const fetchData = async () => {
            const res = await temporaryLeaveService.getUpdateHistory(Number(id));
            const data = res.data || [];
...
export default TabTemporaryLeaveUpdateHistory;
